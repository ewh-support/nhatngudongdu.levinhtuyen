...
function D_Calendar(thismode)
{
	...
	this.html = function() {
		...
		if(this.mode != "week")
		{
			html += "<table width='100%' class='calendar_title'>";
				html += "<tr>";
					html += "<td class='month_down' id='month_down'>";
						html += "<a onclick='minusMonth();return false;' href='#'>";
							html += "<img border='0' alt='Previous Month' src='" +  getBaseURL() + "/img/leftarrow.png' class='month_down_img' id='month_down_img'>";
						html += "</a>";
					html += "</td>";
					...
					html += "<td class='month_up' id='month_up'>";
						html += "<a onclick='plusMonth();return false;' href='#'>";
							html += "<img border='0' alt='Next Month' src='" +  getBaseURL() + "/img/rightarrow.png' class='month_up_img' id='month_up_img'>";
						html += "</a>";
					html += "</td>";
				html += "</tr>";
			html += "</table>";
